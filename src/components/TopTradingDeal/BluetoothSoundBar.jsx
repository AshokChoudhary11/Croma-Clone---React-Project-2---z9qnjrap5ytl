...
const BluetoothSoundBar = () => {
  ...
  const GetProduct = async () => {
    const responce = await fetch(
      "https://academics.newtonschool.co/api/v1/ecommerce/product/65155e162a33ad3adf6705e4",
      {
        method: "GET",
        headers: {
    ...
    <div className={Style.CardContainer} onClick={viewProduct}>
      ...
      <div className={Style.cantent}>
        ...
        <div className={Style.productPrice}>
          <CurrencyRupeeIcon style={{ fontSize: "16px", fontWeight: "600" }} />
          {product.price}
        </div>
        <Rating
          name="product-rating"
...
export default BluetoothSoundBar;
